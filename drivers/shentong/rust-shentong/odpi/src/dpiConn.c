        ...
        const dpiConnCreateParams *createParams, dpiError *error)
{
    ...
    // ShenTong ACI does not support ATTR_STMTCACHESIZE (176); ignore failures.
    dpiOci__attrSet(conn->handle, DPI_OCI_HTYPE_SVCCTX,
            (void*) &commonParams->stmtCacheSize, 0,
            DPI_OCI_ATTR_STMTCACHESIZE, NULL, error);
