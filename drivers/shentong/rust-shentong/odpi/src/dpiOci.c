...
static void *dpiOci__allocateMem(UNUSED void *unused, size_t size)
{
    ...
    ptr = malloc(size);
    dpiDebug__print("ACI allocated %u bytes at %p\n", size, ptr);
    return ptr;
}
        ...
        void **msgId, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIAQDeq", dpiOciSymbols.fnAqDeq)
        ...
        void **payloadInd, void **msgId, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIAQDeqArray", dpiOciSymbols.fnAqDeqArray)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void **msgId, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIAQEnq", dpiOciSymbols.fnAqEnq)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void **payloadInd, void **msgId, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIAQEnqArray", dpiOciSymbols.fnAqEnqArray)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t handleType, uint32_t arraySize, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIArrayDescriptorAlloc",
...
int dpiOci__arrayDescriptorFree(void **handle, uint32_t handleType)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIArrayDescriptorFree",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
    fprintf(stderr, "[ODPI-DBG] ACIAttrGet: handle=%p handleType=%u attr=%u action='%s'\n",
            handle, handleType, attribute, action ? action : "(null)");
    fflush(stderr);
    status = (*dpiOciSymbols.fnAttrGet)(handle, handleType, ptr, size,
            attribute, error->handle);
    fprintf(stderr, "[ODPI-DBG] ACIAttrGet returned: %d\n", status);
    fflush(stderr);
        ...
        uint32_t size, uint32_t attribute, const char *action, dpiError *error)
{
    ...
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
    fprintf(stderr, "[ODPI-DBG] ACIAttrSet: handle=%p handleType=%u attr=%u size=%u action='%s'\n",
            handle, handleType, attribute, size, action ? action : "(null)");
    fflush(stderr);
    status = (*dpiOciSymbols.fnAttrSet)(handle, handleType, ptr, size,
            attribute, error->handle);
    fprintf(stderr, "[ODPI-DBG] ACIAttrSet returned: %d\n", status);
    fflush(stderr);
    if (!action)
        return DPI_SUCCESS;
    DPI_OCI_CHECK_AND_RETURN(error, status, NULL, action);
        ...
        int32_t nameLength, int dynamicBind, dpiVar *var, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIBindByName", dpiOciSymbols.fnBindByName)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        int32_t nameLength, int dynamicBind, dpiVar *var, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIBindByName2", dpiOciSymbols.fnBindByName2)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        int dynamicBind, dpiVar *var, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIBindByPos", dpiOciSymbols.fnBindByPos)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        int dynamicBind, dpiVar *var, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIBindByPos2", dpiOciSymbols.fnBindByPos2)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__bindDynamic(dpiVar *var, void *bindHandle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIBindDynamic", dpiOciSymbols.fnBindDynamic)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__bindObject(dpiVar *var, void *bindHandle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIBindObject", dpiOciSymbols.fnBindObject)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__break(dpiConn *conn, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIBreak", dpiOciSymbols.fnBreak)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void *coll, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACICollAppend", dpiOciSymbols.fnCollAppend)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        const void *elemInd, void *coll, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACICollAssignElem", dpiOciSymbols.fnCollAssignElem)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void **elem, void **elemInd, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACICollGetElem", dpiOciSymbols.fnCollGetElem)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__collSize(dpiConn *conn, void *coll, int32_t *size, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACICollSize", dpiOciSymbols.fnCollSize)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACICollTrim", dpiOciSymbols.fnCollTrim)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void **value, int checkError, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIContextGetValue", dpiOciSymbols.fnContextGetValue)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void *value, int checkError, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIContextSetValue", dpiOciSymbols.fnContextSetValue)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDateTimeConstruct",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDateTimeConvert", dpiOciSymbols.fnDateTimeConvert)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint8_t *month, uint8_t *day, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDateTimeGetDate", dpiOciSymbols.fnDateTimeGetDate)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint8_t *minute, uint8_t *second, uint32_t *fsecond, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDateTimeGetTime", dpiOciSymbols.fnDateTimeGetTime)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        int8_t *tzHourOffset, int8_t *tzMinuteOffset, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDateTimeGetTimeZoneOffset",
        ...
        void *outHandle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDateTimeIntervalAdd",
        ...
        void *interval, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDateTimeSubtract",
...
int dpiOci__dbShutdown(dpiConn *conn, uint32_t mode, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDBShutdown", dpiOciSymbols.fnDbShutdown)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDBStartup", dpiOciSymbols.fnDbStartup)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiVar *var, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDefineByPos", dpiOciSymbols.fnDefineByPos)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
    fprintf(stderr, "SHENTONG_DEBUG: dpiOci__defineByPos() pos=%u, oracleType=%d, sizeInBytes=%u, isDynamic=%d\n",
            pos, (int)var->type->oracleType, (unsigned)var->sizeInBytes, var->isDynamic);
        ...
        dpiVar *var, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDefineByPos2", dpiOciSymbols.fnDefineByPos2)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
    fprintf(stderr, "SHENTONG_DEBUG: dpiOci__defineByPos2() pos=%u, oracleType=%d, sizeInBytes=%llu, isDynamic=%d\n",
            pos, (int)var->type->oracleType, (unsigned long long)var->sizeInBytes, var->isDynamic);
...
int dpiOci__defineDynamic(dpiVar *var, void *defineHandle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDefineDynamic", dpiOciSymbols.fnDefineDynamic)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__defineObject(dpiVar *var, void *defineHandle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDefineObject", dpiOciSymbols.fnDefineObject)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint8_t objType, void *describeHandle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDescribeAny", dpiOciSymbols.fnDescribeAny)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        const uint32_t handleType, const char *action, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDescriptorAlloc", dpiOciSymbols.fnDescriptorAlloc)
...
int dpiOci__descriptorFree(void *handle, uint32_t handleType)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIDescriptorFree", dpiOciSymbols.fnDescriptorFree)
        ...
        uint16_t ncharsetId, dpiError *error)
{
    ...
    *envHandle = NULL;
    DPI_OCI_LOAD_SYMBOL("ACIEnvNlsCreate", dpiOciSymbols.fnEnvNlsCreate)
    ...
    // On Windows, Rust's std::env::set_var only updates the Win32 environment
    // block via SetEnvironmentVariableW. ShenTong aci.dll uses its own MSVCRT
    // CRT copy of getenv(), which reads from the CRT env block (not Win32 env).
    // Propagate TNS_ADMIN from Win32 env into the CRT env so ACI can find
    // tnsnames.aci and sqlnet.aci.
    {
        char tns_buf[1024];
        DWORD tns_len = GetEnvironmentVariableA("TNS_ADMIN", tns_buf, sizeof(tns_buf));
        if (tns_len > 0 && tns_len < sizeof(tns_buf)) {
            _putenv_s("TNS_ADMIN", tns_buf);
            fprintf(stderr, "[ODPI-DBG] Win32 TNS_ADMIN=%s; propagated to CRT\n", tns_buf);
        } else {
            fprintf(stderr, "[ODPI-DBG] Win32 TNS_ADMIN not set (len=%lu)\n", tns_len);
        }
        fprintf(stderr, "[ODPI-DBG] CRT TNS_ADMIN=%s\n",
                getenv("TNS_ADMIN") ? getenv("TNS_ADMIN") : "(null)");
        fflush(stderr);
    }
    // Apply ShenTong ACI compatibility fixes only for the connection env
    // (charsetId=852, GBK). The validation env (charsetId=873) is left as-is
    // so library probing works correctly.
    uint32_t aci_mode = mode;
    uint16_t aci_charset = charsetId;
    uint16_t aci_ncharset = ncharsetId;
    if (charsetId == 852) {
        // ShenTong ACI: use charset=871 (ShenTong UTF-8) to enable EZConnect
        // parsing of host:port/service strings. charset=852 (GBK) causes ACI to
        // treat all connect strings as TNS aliases, failing with ORA-12154.
        // Also strip THREADED bit (bit 0); direct ACI FFI uses mode=2 (ACI_OBJECT).
        aci_charset = 871;
        aci_ncharset = 871;
        aci_mode = (mode & ~1u);  // remove THREADED bit
        if (aci_mode == 0) aci_mode = 2;  // ensure ACI_OBJECT is set
    }
    fprintf(stderr, "[ODPI-DBG] ACIEnvNlsCreate: charsetId=%u->%u ncharsetId=%u->%u mode=%u->%u\n",
            (unsigned)charsetId, (unsigned)aci_charset,
            (unsigned)ncharsetId, (unsigned)aci_ncharset,
            (unsigned)mode, (unsigned)aci_mode);
    fprintf(stderr, "[ODPI-DBG] TNS_ADMIN(CRT)=%s\n",
            getenv("TNS_ADMIN") ? getenv("TNS_ADMIN") : "(null)");
    fflush(stderr);
    status = (*dpiOciSymbols.fnEnvNlsCreate)(envHandle, aci_mode, NULL, mallocFn,
            reallocFn, freeFn, 0, NULL, aci_charset, aci_ncharset);
    fprintf(stderr, "[ODPI-DBG] ACIEnvNlsCreate result: status=%d envHandle=%p\n",
            status, *envHandle);
    fflush(stderr);
    if (*envHandle) {
        ...
        const char *action, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIErrorGet", dpiOciSymbols.fnErrorGet)
        ...
        const char *action, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIHandleAlloc", dpiOciSymbols.fnHandleAlloc)
...
int dpiOci__handleFree(void *handle, uint32_t handleType)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIHandleFree", dpiOciSymbols.fnHandleFree)
        ...
        const void *interval, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIIntervalGetDaySecond",
        ...
        int32_t *month, const void *interval, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIIntervalGetYearMonth",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIIntervalSetDaySecond",
        ...
        void *interval, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIIntervalSetYearMonth",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIJsonDomDocGet", dpiOciSymbols.fnJsonDomDocGet)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint64_t valueLength, uint32_t flags, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIJsonTextBufferParse",
...
#if  defined (_WIN32 )
	loadParams->handle = LoadLibraryA(name);
#else
        ...
        dpiError *error)
{
    ...
    if (dpiOci__loadSymbol("ACIClientVersion",
            (void**) &dpiOciSymbols.fnClientVersion, NULL) < 0)
        return dpiError__set(error, "load symbol ACIClientVersion",
    ...
    fprintf(stderr, "SHENTONG_DEBUG: ACIClientVersion returned: %d.%d.%d.%d.%d\n",
            clientVersionInfo->versionNum, clientVersionInfo->releaseNum,
            clientVersionInfo->updateNum, clientVersionInfo->portReleaseNum,
            clientVersionInfo->portUpdateNum);
	...
	*/
    ...
    DPI_OCI_LOAD_SYMBOL("ACIAttrGet", dpiOciSymbols.fnAttrGet)
    DPI_OCI_LOAD_SYMBOL("ACIAttrSet", dpiOciSymbols.fnAttrSet)
	/*aci not support
    DPI_OCI_LOAD_SYMBOL("ACIThreadKeyGet", dpiOciSymbols.fnThreadKeyGet)
	*/
...
int dpiOci__lobClose(dpiLob *lob, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobClose", dpiOciSymbols.fnLobClose)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__lobCreateTemporary(dpiLob *lob, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobCreateTemporary",
...
int dpiOci__lobFileExists(dpiLob *lob, int *exists, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobFileExists", dpiOciSymbols.fnLobFileExists)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobFileGetName", dpiOciSymbols.fnLobFileGetName)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobFileSetName", dpiOciSymbols.fnLobFileSetName)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobFreeTemporary",
...
int dpiOci__lobGetChunkSize(dpiLob *lob, uint32_t *size, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobGetChunkSize", dpiOciSymbols.fnLobGetChunkSize)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__lobGetLength2(dpiLob *lob, uint64_t *size, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobGetLength2", dpiOciSymbols.fnLobGetLength2)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__lobIsOpen(dpiLob *lob, int *isOpen, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobIsOpen", dpiOciSymbols.fnLobIsOpen)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    *isTemporary = 0;
    DPI_OCI_LOAD_SYMBOL("ACILobIsTemporary", dpiOciSymbols.fnLobIsTemporary)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__lobLocatorAssign(dpiLob *lob, void **copiedHandle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobLocatorAssign",
...
int dpiOci__lobOpen(dpiLob *lob, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobOpen", dpiOciSymbols.fnLobOpen)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobRead2", dpiOciSymbols.fnLobRead2)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__lobTrim2(dpiLob *lob, uint64_t newLength, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobTrim2", dpiOciSymbols.fnLobTrim2)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint64_t valueLength, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACILobWrite2", dpiOciSymbols.fnLobWrite2)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
    charsetId = (lob->type->charsetForm == DPI_SQLCS_NCHAR) ?
            lob->env->ncharsetId : lob->env->charsetId;
        ...
        int checkError, dpiError *error)
{
    ...
    *ptr = NULL;
    DPI_OCI_LOAD_SYMBOL("ACIMemoryAlloc", dpiOciSymbols.fnMemoryAlloc)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
{
    DPI_OCI_LOAD_SYMBOL("ACIMemoryFree", dpiOciSymbols.fnMemoryFree)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACINlsCharSetConvert",
        ...
        uint16_t charsetId, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACINlsCharSetIdToName",
...
int dpiOci__nlsCharSetNameToId(void *envHandle, const char *name,
        uint16_t *charsetId, dpiError *error)
{
    DPI_OCI_LOAD_SYMBOL("ACINlsCharSetNameToId",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACINlsEnvironmentVariableGet",
        ...
        const char *source, uint32_t flag, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACINlsNameMap", dpiOciSymbols.fnNlsNameMap)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACINlsNumericInfoGet",
            dpiOciSymbols.fnNlsNumericInfoGet)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
    fprintf(stderr, "[ODPI-DBG] ACINlsNumericInfoGet: item=%u envHandle=%p errhp=%p\n",
            (unsigned)item, envHandle, error->handle);
    fflush(stderr);
    status = (*dpiOciSymbols.fnNlsNumericInfoGet)(envHandle, error->handle,
            value, item);
    fprintf(stderr, "[ODPI-DBG] ACINlsNumericInfoGet returned: %d value=%d\n", status, (int)*value);
    fflush(stderr);
        ...
        unsigned int flags, void *number, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACINumberFromInt", dpiOciSymbols.fnNumberFromInt)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__numberFromReal(const double value, void *number, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACINumberFromReal", dpiOciSymbols.fnNumberFromReal)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        unsigned int flags, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACINumberToInt", dpiOciSymbols.fnNumberToInt)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__numberToReal(double *value, void *number, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACINumberToReal", dpiOciSymbols.fnNumberToReal)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void *sourceIndicator, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIObjectCopy", dpiOciSymbols.fnObjectCopy)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIObjectFree", dpiOciSymbols.fnObjectFree)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void **tdo, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIObjectGetAttr", dpiOciSymbols.fnObjectGetAttr)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__objectGetInd(dpiObject *obj, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIObjectGetInd", dpiOciSymbols.fnObjectGetInd)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__objectNew(dpiObject *obj, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIObjectNew", dpiOciSymbols.fnObjectNew)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIObjectPin", dpiOciSymbols.fnObjectPin)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIObjectSetAttr", dpiOciSymbols.fnObjectSetAttr)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t newPasswordLength, uint32_t mode, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIPasswordChange", dpiOciSymbols.fnPasswordChange)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t pos, const char *action, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIParamGet", dpiOciSymbols.fnParamGet)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__ping(dpiConn *conn, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIPing", dpiOciSymbols.fnPing)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t valueLength, void **handle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIRawAssignBytes", dpiOciSymbols.fnRawAssignBytes)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__rawPtr(void *envHandle, void *handle, void **ptr)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIRawPtr", dpiOciSymbols.fnRawPtr)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIRawResize", dpiOciSymbols.fnRawResize)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__rawSize(void *envHandle, void *handle, uint32_t *size)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIRawSize", dpiOciSymbols.fnRawSize)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIRowidToChar", dpiOciSymbols.fnRowidToChar)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
    origSize = *bufferSize;
        ...
        uint32_t connectStringLength, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIServerAttach", dpiOciSymbols.fnServerAttach)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
    {
        char tns_buf[1024];
        DWORD tns_len = GetEnvironmentVariableA("TNS_ADMIN", tns_buf, sizeof(tns_buf));
        fprintf(stderr, "[ODPI-DBG] ACIServerAttach: Win32 TNS_ADMIN=%s CRT=%s\n",
                tns_len > 0 ? tns_buf : "(null)",
                getenv("TNS_ADMIN") ? getenv("TNS_ADMIN") : "(null)");
    }
    fprintf(stderr, "[ODPI-DBG] ACIServerAttach: srvhp=%p errhp=%p cs='%.*s' len=%d env=%p\n",
            conn->serverHandle, error->handle,
            (int)connectStringLength, connectString, (int)connectStringLength,
            conn->env->handle);
    fflush(stderr);
    ...
    fprintf(stderr, "[ODPI-DBG] ACIServerAttach returned: %d\n", status);
    fflush(stderr);
...
int dpiOci__serverDetach(dpiConn *conn, int checkError, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIServerDetach", dpiOciSymbols.fnServerDetach)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t mode, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISessionBegin", dpiOciSymbols.fnSessionBegin)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
    // ShenTong ACI does not support OCI_STMT_CACHE (0x40) mode flag.
    // Strip it to avoid "模式值错误" (invalid mode value) error.
    mode &= ~((uint32_t) 0x00000040);
    fprintf(stderr, "[ODPI-DBG] ACISessionBegin: credentialType=%u mode=0x%x\n",
            credentialType, mode);
    fflush(stderr);
    status = (*dpiOciSymbols.fnSessionBegin)(conn->handle, error->handle,
            conn->sessionHandle, credentialType, mode);
    fprintf(stderr, "[ODPI-DBG] ACISessionBegin returned: %d\n", status);
    fflush(stderr);
...
int dpiOci__sessionEnd(dpiConn *conn, int checkError, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISessionEnd", dpiOciSymbols.fnSessionEnd)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t *outTagLength, int *found, uint32_t mode, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISessionGet", dpiOciSymbols.fnSessionGet)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t mode, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISessionPoolCreate",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISessionPoolDestroy",
        ...
        uint32_t mode, int checkError, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISessionRelease", dpiOciSymbols.fnSessionRelease)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint16_t colType, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIShardingKeyColumnAdd",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaBulkInsert", dpiOciSymbols.fnSodaBulkInsert)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaBulkInsertAndGet",
...
//   Wrapper for ACISodaBulkInsertAndGetWithOpts().
//-----------------------------------------------------------------------------
        ...
        uint32_t mode, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaBulkInsertAndGetWithOpts",
        ...
        uint32_t mode, void **handle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaCollCreateWithMetadata",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaCollDrop", dpiOciSymbols.fnSodaCollDrop)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void **collectionHandle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaCollGetNext", dpiOciSymbols.fnSodaCollGetNext)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaCollList", dpiOciSymbols.fnSodaCollList)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t mode, void **handle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaCollOpen", dpiOciSymbols.fnSodaCollOpen)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__sodaCollTruncate(dpiSodaColl *coll, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaCollTruncate",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaDataGuideGet",
        ...
        uint64_t *count, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaDocCount", dpiOciSymbols.fnSodaDocCount)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaDocGetNext", dpiOciSymbols.fnSodaDocGetNext)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t mode, void **handle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaFind", dpiOciSymbols.fnSodaFind)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t mode, void **handle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaFindOne", dpiOciSymbols.fnSodaFindOne)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t indexSpecLength, uint32_t mode, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaIndexCreate", dpiOciSymbols.fnSodaIndexCreate)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t nameLength, uint32_t mode, int *isDropped, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaIndexDrop", dpiOciSymbols.fnSodaIndexDrop)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaInsert", dpiOciSymbols.fnSodaInsert)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaInsertAndGet",
...
//   Wrapper for ACISodaInsertAndGetWithOpts().
//-----------------------------------------------------------------------------
        ...
        void *operOptions, uint32_t mode, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaInsertAndGetWithOpts",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaOperKeysSet", dpiOciSymbols.fnSodaOperKeysSet)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint64_t *count, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaRemove", dpiOciSymbols.fnSodaRemove)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t mode, int *isReplaced, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaReplOne", dpiOciSymbols.fnSodaReplOne)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void **handle, uint32_t mode, int *isReplaced, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaReplOneAndGet",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaSave", dpiOciSymbols.fnSodaSave)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaSaveAndGet", dpiOciSymbols.fnSodaSaveAndGet)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
//   Wrapper for ACISodaSaveAndGetWithOpts().
//-----------------------------------------------------------------------------
        ...
        void *operOptions, uint32_t mode, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISodaSaveAndGetWithOpts",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIStmtExecute", dpiOciSymbols.fnStmtExecute)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
    fprintf(stderr, "SHENTONG_DEBUG: ACIStmtExecute numIters=%u mode=0x%x\n", numIters, mode);
    status = (*dpiOciSymbols.fnStmtExecute)(stmt->conn->handle, stmt->handle,
            error->handle, numIters, 0, 0, 0, mode);
    fprintf(stderr, "SHENTONG_DEBUG: ACIStmtExecute returned: %d\n", status);
        ...
        int32_t offset, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIStmtFetch2", dpiOciSymbols.fnStmtFetch2)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void *bindHandles[], dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIStmtGetBindInfo", dpiOciSymbols.fnStmtGetBindInfo)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__stmtGetNextResult(dpiStmt *stmt, void **handle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIStmtGetNextResult",
        ...
        const char *tag, uint32_t tagLength, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIStmtPrepare2", dpiOciSymbols.fnStmtPrepare2)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
    fprintf(stderr, "SHENTONG_DEBUG: ACIStmtPrepare2 sql='%.*s' sqlLen=%u\n",
            (sqlLength < 200) ? sqlLength : 200, sql, sqlLength);
    status = (*dpiOciSymbols.fnStmtPrepare2)(stmt->conn->handle, &stmt->handle,
            ...
            DPI_OCI_DEFAULT);
    fprintf(stderr, "SHENTONG_DEBUG: ACIStmtPrepare2 returned: %d\n", status);
    if (DPI_OCI_ERROR_OCCURRED(status)) {
        stmt->handle = NULL;
        ...
        int checkError, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIStmtRelease", dpiOciSymbols.fnStmtRelease)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t valueLength, void **handle, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIStringAssignText",
...
int dpiOci__stringPtr(void *envHandle, void *handle, char **ptr)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIStringPtr", dpiOciSymbols.fnStringPtr)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIStringResize", dpiOciSymbols.fnStringResize)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__stringSize(void *envHandle, void *handle, uint32_t *size)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIStringSize", dpiOciSymbols.fnStringSize)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISubscriptionRegister",
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACISubscriptionUnRegister",
...
int dpiOci__tableDelete(dpiObject *obj, int32_t index, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITableDelete", dpiOciSymbols.fnTableDelete)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITableExists", dpiOciSymbols.fnTableExists)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__tableFirst(dpiObject *obj, int32_t *index, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITableFirst", dpiOciSymbols.fnTableFirst)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__tableLast(dpiObject *obj, int32_t *index, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITableLast", dpiOciSymbols.fnTableLast)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        int *exists, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITableNext", dpiOciSymbols.fnTableNext)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        int *exists, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITablePrev", dpiOciSymbols.fnTablePrev)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__tableSize(dpiObject *obj, int32_t *size, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITableSize", dpiOciSymbols.fnTableSize)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__threadKeyDestroy(void *envHandle, void *errorHandle, void **key,
        dpiError *error)
{
    DPI_OCI_LOAD_SYMBOL("ACIThreadKeyDestroy",
        ...
        void *destroyFunc, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIThreadKeyInit", dpiOciSymbols.fnThreadKeyInit)
        ...
        void *value, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACIThreadKeySet", dpiOciSymbols.fnThreadKeySet)
...
int dpiOci__transCommit(dpiConn *conn, uint32_t flags, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITransCommit", dpiOciSymbols.fnTransCommit)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
//   Wrapper for ACITransDetach().
//-----------------------------------------------------------------------------
int dpiOci__transDetach(dpiConn *conn, uint32_t flags, dpiError *error)
{
    int status;

    DPI_OCI_LOAD_SYMBOL("ACITransDetach", dpiOciSymbols.fnTransDetach)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
//   Wrapper for ACITransForget().
//-----------------------------------------------------------------------------
int dpiOci__transForget(dpiConn *conn, dpiError *error)
{
    int status;

    DPI_OCI_LOAD_SYMBOL("ACITransForget", dpiOciSymbols.fnTransForget)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__transPrepare(dpiConn *conn, int *commitNeeded, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITransPrepare", dpiOciSymbols.fnTransPrepare)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
...
int dpiOci__transRollback(dpiConn *conn, int checkError, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITransRollback", dpiOciSymbols.fnTransRollback)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t flags, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITransStart", dpiOciSymbols.fnTransStart)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        void **tdo, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITypeByName", dpiOciSymbols.fnTypeByName)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
        ...
        uint32_t nameLength, void **tdo, dpiError *error)
{
    ...
    DPI_OCI_LOAD_SYMBOL("ACITypeByFullName", dpiOciSymbols.fnTypeByFullName)
    DPI_OCI_ENSURE_ERROR_HANDLE(error)
