...
static const char* const dpiErrorMessages[DPI_ERR_MAX - DPI_ERR_NO_ERR] = {
    ...
    "DPI-1005: unable to acquire ShenTong environment handle", // DPI_ERR_CREATE_ENV
    ...
    "DPI-1014: conversion between ShenTong type %d and native type %d is not implemented", // DPI_ERR_UNHANDLED_CONVERSION
    ...
    "DPI-1021: ShenTong type %u is invalid", // DPI_ERR_INVALID_ORACLE_TYPE
    ...
    "DPI-1044: value cannot be represented as an ShenTong number", // DPI_ERR_NUMBER_NO_REPR
    ...
    "DPI-1047: Cannot locate a %s-bit ShenTong Client library: \"%s\". See %s for help", // DPI_ERR_LOAD_LIBRARY
    "DPI-1049: symbol %s not found in OCI library", // DPI_ERR_LOAD_SYMBOL
    "DPI-1050: ShenTong Client library is at version %d.%d but version %d.%d or higher is needed", // DPI_ERR_ORACLE_CLIENT_TOO_OLD
    ...
    "DPI-1055: value is not a number (NaN) and cannot be used in ShenTong numbers", // DPI_ERR_NAN
    ...
    "DPI-1066: ShenTong Database is at version %d.%d but version %d.%d or higher is needed", // DPI_ERR_ORACLE_DB_TOO_OLD
    ...
    "DPI-1072: the ShenTong Client library version is unsupported", // DPI_ERR_ORACLE_CLIENT_UNSUPPORTED
    ...
    "DPI-1078: native type %d with ShenTong type %d is not supported by JSON", // DPI_ERR_UNHANDLED_CONVERSION_TO_JSON
    "DPI-1079: ShenTong Client library is at version %d.%d but either version %d.%d (or later DBRU) or version %d.%d (or higher) is needed", // DPI_ERR_ORACLE_CLIENT_TOO_OLD_MULTI
