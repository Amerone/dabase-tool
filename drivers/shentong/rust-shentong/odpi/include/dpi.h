...
#define DPI_VISIBILITY_DEFAULT __attribute__((visibility("default")))
#else
#define DPI_VISIBILITY_DEFAULT
#endif
...
#elif defined(LINUX)
#define DPI_EXPORT DPI_VISIBILITY_DEFAULT
#else
#define DPI_EXPORT
#endif
...
DPI_EXPORT void __get_stodpi_info();
